...
prod.descricao as 'Produtos',
vend.quantidade as 'Quantidade',
vend.valor as 'Valor'
...
select forn.nome as 'Nome',prod.lote as 'Lote',
prod.validade as 'Validade',forn.email as 'E-mail',
prod.quantidade as 'Quantidade',
forn.cnpj,prod.preco as 'Preco'
